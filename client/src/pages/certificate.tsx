                  ...
                  {certificatesLoading ? (
                      ...
                      {certificates.map(certificate => (
                        <div key={certificate.id} className="border border-gray-200 rounded-lg p-4 flex justify-between items-center">
                          ...
                          <button 
                            ...
                            className="bg-primary hover:bg-[#F14B05]/90 text-white px-4 py-2 rounded text-sm font-medium transition-colors"
                          >
                            Download
                          </button>
                        </div>
                    ...
                    <div className="text-center py-8 border border-gray-200 rounded-lg">
                      ...
                      <div className="mt-6">
                        <a 
                          href="/events" 
                          className="inline-block bg-primary hover:bg-[#F14B05]/90 text-white px-4 py-2 rounded text-sm font-medium transition-colors"
                        >
