  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:transform hover:scale-105">
      ...
      <div className="p-6">
        ...
        <Link href={`/projects/${id}`} className="inline-block bg-primary hover:bg-[#F14B05]/90 text-white px-4 py-2 rounded text-sm font-medium transition-colors w-full text-center">
          Learn More
        </Link>
      </div>
    </div>
